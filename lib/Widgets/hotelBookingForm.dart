...
class bookingState extends State<booking> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      appBar: AppBar(backgroundColor:Colors.red ,title: Text("Hotel Booking")),
      body: /* Column(
        children: <Widget>[
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(height: 50,
              ...
              child: Center(
                  child: Text("Check in Date", style: TextStyle(fontSize: 18,),)
              ),),
            ListTile(
              title: Text("Check in Date: ${_chkInDate.year}, ${_chkInDate.month}, ${_chkInDate.day}"),
            ...
            Container(height: 50,
              ...
              color: Colors.yellowAccent[400],
              child: Center(
                  child: Text("Check out Date", style: TextStyle(fontSize: 18,),)
              ),),
            ListTile(
              title: Text("Check out Date: ${_chkOutDate.year}, ${_chkOutDate.month}, ${_chkOutDate.day}"),
              trailing: Icon(Icons.keyboard_arrow_down),
            ...
            Container(height: 50,
              ...
              color: Colors.yellowAccent[400],
              child: Center(
                  child: Text("Number of Adults", style: TextStyle(fontSize: 18,),)
              ),),
            Container(
            ...
            Container(height: 50,
              ...
              color: Colors.yellowAccent[400],
              child: Center(
                  child: Text("Number of Children (Less than 5 years of age)", style: TextStyle(fontSize: 18,),)
              ),),
            Container(
              child: DropdownButton<String>(
                value: _noOfChildren,
              ...
              color: Colors.yellowAccent[400],
              child: Center(
                  child: Text("Number of Rooms", style: TextStyle(fontSize: 18,),)
              ),),
            Container(
              child: DropdownButton<String>(
                value: _noOfRooms,
